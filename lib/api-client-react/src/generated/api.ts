 ...
 */
export const submitOnboarding = async (onboardingInput: OnboardingInput, options?: RequestInit): Promise<UserProfileResponse> => {
 ...
 */
export const updateUserProfile = async (onboardingInput: OnboardingInput, options?: RequestInit): Promise<UserProfileResponse> => {
